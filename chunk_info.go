...
const (
	...
	// Specifies the date the subject of the file was created. List dates
	// in year-month-day format, padding one-digit months and days with a
	// zero on the left. For example: 1553-05-03 for May 3, 1553. The
	// year should always be given using four digits.
	// String value: "ICRD"
	LabICRD uint32 = 0x49435244

	// Stores the name of the engineer who worked on the file. If there
	// are multiple engineers, separate the names by a semicolon and a blank.
	// String value: "IENG"
	LabIENG uint32 = 0x49454e47

	// Describes the genre, such as jazz, classical, rock, etc.
	// String value: "IGNR"
	...
	// Describes the original subject of the file, such as record,
	// CD and so forth.
	// String value: "IMED"
	...
	// Specifies the name of the title the file was originally
	// intended for (Album).
	// String value: "IPRD"
	...
	// Describes the contents of the file, such as ListItems Management.
	// String value: "ISBJ"
	...
	// Identifies the name of the person or organization who
	...
	// such as record, sampling CD, TV sound track and so forth.
...
// ChunkINFO represents INFO sub-chunk of LIST chunk.
...
// INFO returns new instance of ChunkINFO.
